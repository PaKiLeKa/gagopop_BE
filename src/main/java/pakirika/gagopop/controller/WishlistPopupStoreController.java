...
import pakirika.gagopop.service.WishlistPopupStoreService;

import java.util.Optional;

@RestController
@RequiredArgsConstructor
public class WishlistPopupStoreController {

    private final PopupStoreRepository popupStoreRepository;
    private final WishlistPopupStoreService wishlistPopupStoreService;
    ...
    public ResponseEntity<String> addToWishlist(@RequestHeader("Authorization") String authorizationHeader,
        ...
        wishlistPopupStoreService.addToWishlist(userEntity, popupStore.get());
